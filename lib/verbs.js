...
function futureActiveIndicatives(stem) {
  return {
    "singular": {
      1: accentuateVerb(amalgamate(stem + futureMorpheme + primarySuffixes.singular[1])),
      2: accentuateVerb(amalgamate(stem + futureMorpheme + primarySuffixes.singular[2])),
      3: accentuateVerb(amalgamate(stem + futureMorpheme + primarySuffixes.singular[3]))
    },
    "plural": {
      1: accentuateVerb(amalgamate(stem + futureMorpheme + primarySuffixes.plural[1])),
      2: accentuateVerb(amalgamate(stem + futureMorpheme + primarySuffixes.plural[2])),
      3: accentuateVerb(amalgamate(stem + futureMorpheme + primarySuffixes.plural[3]))
    }
  };
};
